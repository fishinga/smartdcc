...
/**
 * Created by bfzhang on 2018/8/17.
 */
@Slf4j
...
//    private static JPushClient jPushClient = new JPushClient(masterSecret,appKey);
    ...
    private static JpushClientUtil instance;
    ...
    private JpushClientUtil() {
        String appKey = "d2e30efb8b1ad04e90b9935e";
        String masterSecret = "fd5544b247d0a77ac1e3a09e";
...
//    }
    ...
    public  PushResult pushByAlias(String userId,String msg,String json) {

        PushPayload payload = buildPushObject_android_ios_alias_alert(userId, msg,json);
        try {
    ...
    public static PushPayload buildPushObject_android_ios_alias_alert(String alias,String alert,String params){
